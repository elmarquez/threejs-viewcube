...
Viewport3D.prototype.makeCompass = function (name, x, y, z, radius, segments, color, opacity) {
...
Viewport3D.prototype.makeCorner = function (name, w, x, y, z, rotations, color) {
...
Viewport3D.prototype.makeEdge = function (name, w, h, x, y, z, rotations, color) {
...
Viewport3D.prototype.makeFace = function (name, w, x, y, z, rotations, color) {
    var self = this;
...
Viewport3D.prototype.onMouseMove = function (event) {
    var self = this;
...
Viewport3D.prototype.onMouseUp = function (event) {
    var self = this;
    // calculate mouse position in normalized device coordinates
    // (-1 to +1) for both components
    self.mouse.x = (event.clientX / window.innerWidth) * 2 - 1;
...
Viewport3D.prototype.setupGeometry = function () {
    ...
    // edges
    var top_front_edge    = self.makeEdge(self.FACES.TOP_FRONT_EDGE, 70, 15,  50,   0, 50, [{axis:Z_AXIS, rad:ROTATE_90}], self.FACE_COLOUR);
    var top_right_edge    = self.makeEdge(self.FACES.TOP_RIGHT_EDGE, 70, 15,   0,  50, 50, [{axis:Z_AXIS, rad:ROTATE_180}], self.FACE_COLOUR);
    var top_back_edge     = self.makeEdge(self.FACES.TOP_BACK_EDGE, 70, 15, -50,   0, 50, [{axis:Z_AXIS, rad:ROTATE_270}], self.FACE_COLOUR);
    var top_left_edge     = self.makeEdge(self.FACES.TOP_LEFT_EDGE, 70, 15,   0, -50, 50, [{axis:Z_AXIS, rad:ROTATE_360}], self.FACE_COLOUR);

    var bottom_front_edge = self.makeEdge(self.FACES.BOTTOM_FRONT_EDGE, 70, 15,  50,   0, -50, [{axis:Z_AXIS, rad:ROTATE_90}, {axis:Y_AXIS, rad:ROTATE_180}], self.FACE_COLOUR);
    var bottom_right_edge = self.makeEdge(self.FACES.BOTTOM_RIGHT_EDGE, 70, 15,   0,  50, -50, [{axis:Z_AXIS, rad:ROTATE_180},{axis:Y_AXIS, rad:ROTATE_180}], self.FACE_COLOUR);
    var bottom_back_edge  = self.makeEdge(self.FACES.BOTTOM_BACK_EDGE, 70, 15, -50,   0, -50, [{axis:Z_AXIS, rad:ROTATE_270},{axis:Y_AXIS, rad:ROTATE_180}], self.FACE_COLOUR);
    var bottom_left_edge  = self.makeEdge(self.FACES.BOTTOM_LEFT_EDGE, 70, 15,   0, -50, -50, [{axis:Z_AXIS, rad:ROTATE_360},{axis:Y_AXIS, rad:ROTATE_180}], self.FACE_COLOUR);

    var front_right_edge  = self.makeEdge(self.FACES.FRONT_RIGHT_EDGE, 70, 15,  50,  50, 0, [{axis:X_AXIS, rad:ROTATE_180},{axis:Y_AXIS, rad:ROTATE_90},{axis:Z_AXIS, rad:0}], self.FACE_COLOUR);
    var back_right_edge   = self.makeEdge(self.FACES.BACK_RIGHT_EDGE, 70, 15, -50,  50, 0, [{axis:X_AXIS, rad:ROTATE_90},{axis:Y_AXIS, rad:ROTATE_180},{axis:Z_AXIS, rad:ROTATE_90}], self.FACE_COLOUR);
    var back_left_edge    = self.makeEdge(self.FACES.BACK_LEFT_EDGE, 70, 15, -50, -50, 0, [{axis:X_AXIS, rad:ROTATE_90},{axis:Y_AXIS, rad:ROTATE_270},{axis:Z_AXIS, rad:ROTATE_90}], self.FACE_COLOUR);
    var front_left_edge   = self.makeEdge(self.FACES.FRONT_LEFT_EDGE, 70, 15,  50, -50, 0, [{axis:X_AXIS, rad:ROTATE_90},{axis:Y_AXIS, rad:ROTATE_360},{axis:Z_AXIS, rad:ROTATE_90}], self.FACE_COLOUR);

    // corners
    var top_front_left_corner  = self.makeCorner(self.FACES.TOP_FRONT_LEFT_CORNER, 15,  50, -50, 50, [{axis:Z_AXIS, rad:ROTATE_90}], self.FACE_COLOUR);
    var top_front_right_corner = self.makeCorner(self.FACES.TOP_FRONT_RIGHT_CORNER, 15,  50,  50, 50, [{axis:Z_AXIS, rad:ROTATE_180}], self.FACE_COLOUR);
    var top_back_right_corner  = self.makeCorner(self.FACES.TOP_BACK_RIGHT_CORNER, 15, -50,  50, 50, [{axis:Z_AXIS, rad:ROTATE_270}], self.FACE_COLOUR);
    var top_back_left_corner   = self.makeCorner(self.FACES.TOP_BACK_LEFT_CORNER, 15, -50, -50, 50, [{axis:Z_AXIS, rad:ROTATE_360}], self.FACE_COLOUR);

    var bottom_front_left_corner  = self.makeCorner(self.FACES.BOTTOM_FRONT_LEFT_CORNER, 15,  50, -50, -50, [{axis:X_AXIS, rad:ROTATE_0},{axis:Y_AXIS, rad:ROTATE_180},{axis:Z_AXIS, rad:ROTATE_0}], self.FACE_COLOUR);
    var bottom_front_right_corner = self.makeCorner(self.FACES.BOTTOM_FRONT_RIGHT_CORNER, 15,  50,  50, -50, [{axis:X_AXIS, rad:ROTATE_90},{axis:Y_AXIS, rad:ROTATE_180},{axis:Z_AXIS, rad:ROTATE_0}], self.FACE_COLOUR);
    var bottom_back_right_corner  = self.makeCorner(self.FACES.BOTTOM_BACK_RIGHT_CORNER, 15, -50,  50, -50, [{axis:X_AXIS, rad:ROTATE_90},{axis:Y_AXIS, rad:ROTATE_180},{axis:Z_AXIS, rad:ROTATE_90}], self.FACE_COLOUR);
    var bottom_back_left_corner   = self.makeCorner(self.FACES.BOTTOM_BACK_LEFT_CORNER, 15, -50, -50, -50, [{axis:X_AXIS, rad:ROTATE_0},{axis:Y_AXIS, rad:ROTATE_180},{axis:Z_AXIS, rad:ROTATE_90}], self.FACE_COLOUR);
...
Viewport3D.prototype.setView = function (view) {
    ...
    switch (view) {
        case self.FACES.TOP:
            self.tweenControlToPosition(0,0,self.OFFSET,0,0,self.ROTATION_90);
            break;
        case self.FACES.FRONT:
            self.tweenControlToPosition(self.OFFSET,0,0,self.ROTATION_0,self.ROTATION_90,self.ROTATION_90);
            break;
        case self.FACES.LEFT:
            self.tweenControlToPosition(0,0,self.OFFSET,0,self.ROTATION_270,self.ROTATION_0);
            break;
        case self.FACES.RIGHT:
            self.tweenControlToPosition(self.OFFSET,0,0,self.ROTATION_0,self.ROTATION_90,self.ROTATION_90);
            break;
        case self.FACES.BACK:
            self.tweenControlToPosition(-self.OFFSET,0,0,0,0,0);
            break;
        case self.FACES.BOTTOM:
            self.tweenControlToPosition(0,0,-self.OFFSET,0,0,0);
            break;
        case self.FACES.TOP_FRONT_EDGE:
            self.tweenControlToPosition(0,0,self.OFFSET,0,self.ROTATION_90 / 2,self.ROTATION_90);
            break;
...
Viewport3D.prototype.tweenControlToPosition = function (x, y, z, rx, ry, rz) {
    var self = this;
    return new Promise(function (resolve) {
        ...
        var finish = {x: x, y: y, z: z, rx: rx, ry: ry, rz: rz};
        ...
        tween.onUpdate(function () {
            ...
            self.camera.rotation.set(this.rx, this.ry, this.rz)
        });
        tween.start();
        self.render();
    });
