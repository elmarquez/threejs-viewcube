...
Viewport3D.prototype.onMouseUp = function (event) {
    ...
    if (intersects.length > 0) {
        ...
        switch (id) {
            default:
                console.dir(intersects[0].object.name || intersects[0].object.uuid);
        }
...
Viewport3D.prototype.setupGeometry = function () {
    ...
    var back_left_edge    = self.makeEdge(self.BACK_LEFT_EDGE, 70, 15, -50, -50, 0, [{axis:X_AXIS, rad:ROTATE_90},{axis:Y_AXIS, rad:ROTATE_270},{axis:Z_AXIS, rad:ROTATE_90}], self.FACE_COLOUR);
    var front_left_edge   = self.makeEdge(self.FRONT_LEFT_EDGE, 70, 15,  50, -50, 0, [{axis:X_AXIS, rad:ROTATE_90},{axis:Y_AXIS, rad:ROTATE_360},{axis:Z_AXIS, rad:ROTATE_90}], self.FACE_COLOUR);
