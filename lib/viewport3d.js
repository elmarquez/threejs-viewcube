...
Viewport3D.prototype.setupGeometry = function () {
    ...
    // faces
    var topFace    = me.makeFace(70,   0,   0,  50,  null,      null, 0xff0000);
    var frontFace  = me.makeFace(70,   0,  50,   0, X_AXIS, Math.PI/2, 0x00ff00);
    var rightFace  = me.makeFace(70,  50,   0,   0, Y_AXIS, Math.PI/2, 0x0000ff);
    var backFace   = me.makeFace(70,   0, -50,   0, X_AXIS, Math.PI/2, 0xff00ff);
    var leftFace   = me.makeFace(70, -50,   0,   0, Y_AXIS, Math.PI/2, 0xffff00);
    var bottomFace = me.makeFace(70,   0,   0, -50,  null,      null, 0x00ffff);
    ...
    // edges
    var top_front_edge    = me.makeEdge(70, 15,  50,   0, 50, [{axis:Z_AXIS, rad:ROTATE_90}], 0x550000);
    var top_right_edge    = me.makeEdge(70, 15,   0,  50, 50, [{axis:Z_AXIS, rad:ROTATE_180}], 0x005500);
    var top_back_edge     = me.makeEdge(70, 15, -50,   0, 50, [{axis:Z_AXIS, rad:ROTATE_270}], 0x000055);
    var top_left_edge     = me.makeEdge(70, 15,   0, -50, 50, [{axis:Z_AXIS, rad:ROTATE_360}], 0x550055);

    var bottom_front_edge = me.makeEdge(70, 15,  50,   0, -50, [{axis:Z_AXIS, rad:ROTATE_90}, {axis:Y_AXIS, rad:ROTATE_180}], 0x555500);
    var bottom_right_edge = me.makeEdge(70, 15,   0,  50, -50, [{axis:Z_AXIS, rad:ROTATE_180},{axis:Y_AXIS, rad:ROTATE_180}], 0x005555);
    var bottom_back_edge  = me.makeEdge(70, 15, -50,   0, -50, [{axis:Z_AXIS, rad:ROTATE_270},{axis:Y_AXIS, rad:ROTATE_180}], 0x555500);
    var bottom_left_edge  = me.makeEdge(70, 15,   0, -50, -50, [{axis:Z_AXIS, rad:ROTATE_360},{axis:Y_AXIS, rad:ROTATE_180}], 0x005555);

    var front_right_edge  = me.makeEdge(70, 15,  50,  50, 0, [{axis:X_AXIS, rad:ROTATE_180},{axis:Y_AXIS, rad:ROTATE_90},{axis:Z_AXIS, rad:0}], 0xAA0000);
    var back_right_edge   = me.makeEdge(70, 15, -50,  50, 0, [{axis:X_AXIS, rad:ROTATE_90},{axis:Y_AXIS, rad:ROTATE_180},{axis:Z_AXIS, rad:ROTATE_90}], 0x00AA00);
    var back_left_edge    = me.makeEdge(70, 15, -50, -50, 0, [{axis:X_AXIS, rad:ROTATE_90},{axis:Y_AXIS, rad:ROTATE_270},{axis:Z_AXIS, rad:ROTATE_90}], 0x0000AA);
    var front_left_edge   = me.makeEdge(70, 15,  50, -50, 0, [{axis:X_AXIS, rad:ROTATE_90},{axis:Y_AXIS, rad:ROTATE_360},{axis:Z_AXIS, rad:ROTATE_90}], 0xAA00AA);
    ...
    // corners
    var top_front_left_corner  = me.makeCorner(15,  50, -50, 50, [{axis:Z_AXIS, rad:ROTATE_90}], 0x00CC00);
    var top_front_right_corner = me.makeCorner(15,  50,  50, 50, [{axis:Z_AXIS, rad:ROTATE_180}], 0xCCCC00);
    var top_back_right_corner  = me.makeCorner(15, -50,  50, 50, [{axis:Z_AXIS, rad:ROTATE_270}], 0x00CCCC);
    var top_back_left_corner   = me.makeCorner(15, -50, -50, 50, [{axis:Z_AXIS, rad:ROTATE_360}], 0xCC00CC);

    var bottom_front_left_corner  = me.makeCorner(15,  50, -50, -50, [{axis:X_AXIS, rad:ROTATE_0},{axis:Y_AXIS, rad:ROTATE_180},{axis:Z_AXIS, rad:ROTATE_0}], 0x00CC00);
    var bottom_front_right_corner = me.makeCorner(15,  50,  50, -50, [{axis:X_AXIS, rad:ROTATE_90},{axis:Y_AXIS, rad:ROTATE_180},{axis:Z_AXIS, rad:ROTATE_0}], 0xCCCC00);
    var bottom_back_right_corner  = me.makeCorner(15, -50,  50, -50, [{axis:X_AXIS, rad:ROTATE_90},{axis:Y_AXIS, rad:ROTATE_180},{axis:Z_AXIS, rad:ROTATE_90}], 0x00CCCC);
    var bottom_back_left_corner   = me.makeCorner(15, -50, -50, -50, [{axis:X_AXIS, rad:ROTATE_0},{axis:Y_AXIS, rad:ROTATE_180},{axis:Z_AXIS, rad:ROTATE_90}], 0xCC00CC);
    ...
    // compass
    var compass = me.makeCompass(0, 0, -55, 90, 64, 0x333366);
    me.scene.add(compass);

    // labels
};

Viewport3D.prototype.makeCompass = function (x, y, z, radius, segments, color) {
    var me = this;
